  ...
  return (
    ...
    >
      <div className="min-h-screen px-4 flex items-center justify-center">
        ...
        <DialogPanel
          transition
          className="inline-block w-full max-w-sm md:max-w-lg overflow-hidden text-left align-middle transition transform bg-gray-50 shadow-xl rounded-2xl duration-300 ease-in-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0"
        >
          <picture>
            <source
          ...
          <div className="px-6 my-4">
            ...
            <div className="my-2 flex flex-row gap-3">
              {data.url ? (
                <a
                  className="p-2 bg-gray-900 rounded-full duration-200 hover:opacity-80"
                  href={data.url}
                  target="_blank"
              ...
              {data.repo ? (
                <a
                  className="flex items-center justify-center p-2 pr-2.5 bg-gray-900 rounded-full duration-200 hover:opacity-80"
                  href={data.repo}
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="mt-4">
              <button
                type="button"
                className="rounded bg-gray-900 text-white px-4 py-1 block ml-auto"
                onClick={closeModal}
              >
                OK
              </button>
